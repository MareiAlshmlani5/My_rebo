...
selected_item_side = st.sidebar.selectbox(
    "Choose an option (Sidebar):",  
    ("Option A", "Option B", "Option C", "Option D") 
)
st.write("You selected:", selected_item_side)

selected_item_main = st.selectbox("Choose option", ["Option A", "Option B"])
if selected_item_main == "Option A":
